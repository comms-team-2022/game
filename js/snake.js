...
import post from "./js-to-server.js";
      ...
      for (ii in myObj) {
        if (myObj[ii].elm.currentStyle) {
          ...
          currentIndex = parseFloat(
            document.defaultView.getComputedStyle(myObj[ii].elm, null).getPropertyValue("z-index"),
            10
          );
        }
    ...
    return function (config) {
      ...
      me.eatFood = function () {
        ...
        while (ii--) {
          ...
          me.snakeBody[index].elm.className = me.snakeHead.elm.className.replace(
            /\bsnake-snakebody-dead\b/,
            ""
          );
      ...
      me.handleDeath = function () {
        ...
        post({ type: "GAME_END", user: "joe", score: me.snakeLength });
      };
    ...
    */
    ...
    return function (inputConfig) {
      ...
      function createBoardElements() {
        ...
        elmAboutPanel.innerHTML = "<a href='credits.html' class='snake-link'>Credits</a>";
      ...
      me.setupPlayingField = function () {
        ...
        var pLabelTop =
          me.getBlockHeight() + fHeight + Math.round((bottomPanelHeight - 30) / 2) + "px";
        ...
        myKeyListener = function (evt) {
          ...
          if (me.getBoardState() === 1) {
            if (
              !(keyNum >= 37 && keyNum <= 40) &&
              !(keyNum === 87 || keyNum === 65 || keyNum === 83 || keyNum === 68)
            ) {
              return;
